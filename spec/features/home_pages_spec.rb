...
describe HomePage do
  ...
  feature 'Edit the HomePage' do
    scenario 'when modifying product reference' do
      expect(@home_page.product).to_not be nil
    ...
    scenario 'when editing a special offer with title', js: true do
      SpecialOffer.create(home_page: @home_page, title: 'bla bla bla')
    ...
    scenario 'when editing a special offer without title', js: true do
      SpecialOffer.create(home_page: @home_page, title: 'bla bla bla')
      ...
      expect(page).to have_content "Page d'accueil mise à jour"
      expect(@home_page.special_offer.title).to eq('bla bla bla')
    end
  end
end
